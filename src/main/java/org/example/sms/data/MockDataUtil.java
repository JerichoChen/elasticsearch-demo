...
public class MockDataUtil {
    private static String[] corpNames = new String[]{"余杭集团", "西溪小镇", "招商银行", "阿里巴巴", "杭州银行", "阿里爸爸"};
    ...
    public static String getRandomContent() {
        ...
        int beginIndex = random.nextInt(content.length() - 20);
        int endIndex = beginIndex + 10 + random.nextInt(10);
